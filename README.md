...
Fields that you want to save/load in your class/struct should have SerializeField attribute (In example below, it will be _position and _health in PlayerData struct).
